  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center text-center bg-gradient-to-r from-white to-[#B6D7F2] overflow-hidden">
      <div className="relative z-10 container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-4 leading-tight text-[rgb(18,27,82)] font-headline">
          Tu marca de invisible a inolvidable.
        </h1>
        <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-[rgb(18,27,82)]/80">
