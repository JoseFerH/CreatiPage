      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-stretch">
          ...
          <div className="order-2 md:order-1 flex flex-col h-full">
            <div>
              ...
              <div className="space-y-6 mb-8 md:mb-0">
                {[
                  ...
                  "Te mostramos cada avance, cada etapa, y cómo todo lo que creamos impacta directamente en el crecimiento de tu negocio."
                ].map((item, index) => (
                  <ScrollReveal 
                    key={index} 
                    direction="right" 
            ...
            <ScrollReveal direction="right" delay={700} duration={800} className="mt-auto pt-12">
          ...
          <div className="order-1 md:order-2 flex justify-center relative h-full items-center">
